			...
			<div class="container wide">
				...
				<div class="header-bottom-container">
					...
					<div class="logo-with-offcanvas d-flex">
						...
						<div class="logo">
							<a href="index.html">
								<img src="{{('public/frontend/images/logo_furni.png')}}" style="width:200px; height: 200px;" class="img-fluid" alt="">
							</a>
						</div>
	...
	<script>
		...
		function init() {
			...
			var mapOptions = {
				...
				center: new google.maps.LatLng(10.3716611,105.4301502), // New York
			...
			var marker = new google.maps.Marker({
				position: new google.maps.LatLng(10.3716611,105.4301502),
				map: map,
				title: 'An Giang University',
