...
@section('content')
						...
						<div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.4.7">
							<ul>
								...
								<li data-index="rs-10"
									...
									data-thumb="{{('public/frontend/images/100x50_slider-homepage6-img1.png')}}"
									data-rotate="0,0,0,0,0,0,0,0" data-saveperformance="off" data-title="Slide" data-param1=""
									data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
									data-param8="" data-param9="" data-param10="" data-description="">
									<!-- MAIN IMAGE -->
									<img src="{{('public/frontend/images/dummy.png')}}" alt=""
										data-lazyload="{{('public/Upload/Slide/Slide-178.png')}}"
									...
									<div class="tp-caption Slider-button-alt rev-btn  tp-resizeme" id="slide-10-layer-20"
										...
										<a class="revslider-button" href="shop-left-sidebar.html"> SHOP NOW</a> </div>
								</li>
								<!-- SLIDE  -->
								<li data-index="rs-11"
									...
									data-thumb="{{('public/frontend/images/100x50_slider-homepage6-img2.png')}}"
									data-rotate="0,0,0,0,0,0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2=""
									data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8=""
									data-param9="" data-param10="" data-description="">
									<!-- MAIN IMAGE -->
									<img src="{{('public/frontend/images/dummy.png')}}" alt=""
										data-lazyload="{{('public/Upload/Slide/Slide-598.jpg')}}"
										data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone"
										data-scalestart="100" data-scaleend="110" data-rotatestart="0" data-rotateend="0" data-blurstart="0"
										data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
								...
								<li data-index="rs-12"
									...
									data-easeout="default,default,default,default,default,default,default,default"
									data-masterspeed="700,default,default,default,default,default,default,default"
									data-thumb="{{('public/frontend/images/100x50_slider-homepage6-img3.png')}}"
									data-rotate="0,0,0,0,0,0,0,0" data-saveperformance="off" data-title="Slide" data-param1=""
									data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7=""
									data-param8="" data-param9="" data-param10="" data-description="">
									<!-- MAIN IMAGE -->
									<img src="{{('public/frontend/images/dummy.png')}}" alt=""
										data-lazyload="{{('public/Upload/Slide/Slide-818.jpg')}}"
										data-bgposition="center center" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone"
										data-scalestart="100" data-scaleend="110" data-rotatestart="0" data-rotateend="0" data-blurstart="0"
										data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
									<!-- LAYERS -->
									...
									<div class="tp-caption   tp-resizeme" id="slide-12-layer-3"
										...
										data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
										style="z-index: 6; white-space: nowrap; font-size: 56px; line-height: 60px; font-weight: 300; color: #333333; letter-spacing: 0px;font-family:Work Sans;">
										Cho khách hàng mua vào ngày sinh nhật </div>
			...
			<div class="row">
				<div class="col-md-4 mb-30">
					...
					<div class="single-category single-category--three">
						...
						<div
							...
							<img src="{{('public/frontend/images/banners/ghe.jpg')}}" class="img-fluid" alt="">
						</div>
						...
						<div
							...
							<div class="title">
								<p><a href="{{URL::to('/product-of-category_12')}}">Ghế <span>Đa dụng</span></a></p>
								<a href="{{URL::to('/product-of-category_12')}}">Shop Now</a>
							</div>
						...
						<a href="{{URL::to('/product-of-category_12')}}" class="banner-link"></a>
				...
				<div class="col-md-4 mb-30">
					...
					<div class="single-category single-category--three">
						...
						<div
							class="single-category__image single-category__image--three single-category__image--three--creativehome single-category__image--three--banner">
							<img src="{{('public/frontend/images/banners/dongho.jpg')}}" class="img-fluid" alt="">
						</div>
						...
						<div
							class="single-category__content single-category__content--three single-category__content--three--creativehome  single-category__content--three--banner mt-25 mb-25">
							<div class="title">
								<p><a href="{{URL::to('/product-of-category_17')}}">Đồng hồ <span>Mini</span></a></p>
								<a href="{{URL::to('/product-of-category_17')}}">Shop Now</a>
							</div>
						...
						<a href="{{URL::to('/product-of-category_17')}}" class="banner-link"></a>
				...
				<div class="col-md-4 mb-30">
					...
					<div class="single-category single-category--three">
						...
						<div
							class="single-category__image single-category__image--three single-category__image--three--creativehome single-category__image--three--banner">
							<img src="{{('public/frontend/images/banners/trangtri.jpg')}}" class="img-fluid" alt="">
						</div>
						...
						<div
							class="single-category__content single-category__content--three single-category__content--three--creativehome  single-category__content--three--banner mt-25 mb-25">
							<div class="title">
								<p><a href="{{URL::to('/product-of-category_18')}}">Trang trí <span>nội thất</span></a></p>
								<a href="{{URL::to('/product-of-category_18')}}">Shop Now</a>
							</div>
						...
						<a href="{{URL::to('/product-of-category_18')}}" class="banner-link"></a>
			...
			<div class="row mb-75">
				<div class="col-6">
					<div
						...
						<p>2020 <span class="line">NEW</span></p>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45">
					<div class="single-product">
						...
						{{-- <form  action="{{URL::to('/add-cart-home/id='.$value->ProductID.'')}}" id="form-add-cart"  method="post">
							@csrf
							<input type="hidden" value="{{$value->ProductSize}}" id="" name="ProSize"/>
							<input type="hidden" name="ProColor" value="{{$value->ProductColor}}">
							--}}
							<input type="hidden" class="cart_product_ID_{{$value->ProductID}}"  value="{{$value->ProductID}}">
							<input type="hidden" class="cart_product_Name_{{$value->ProductID}}"  value="{{$value->ProductName}}">
						...
						<div class="single-product__content">
							<div class="title">
								...
								<a class="add-to-cart" href="{{URL::to('/add-cart-home/id='.$value->ProductID.'')}}" data-link="{{URL::to('/add-cart-home/id='.$value->ProductID.'')}}" data-id-product="{{$value->ProductID}}">Thêm vào giỏ hàng</a>
							</div>
							<div class="price">
								<span class="discounted-price">{{number_format($value->ProductPrice,2)}} VND</span>
							</div>
						</div>
						{{-- </form> --}}
					...
					<div class="row align-items-center">
						<div class="col-lg-4 col-xl-5">
							<div class="countdown-image text-center">
								<img src="{{('public/frontend/images/countdown-4.png')}}" class="img-fluid" alt="">
							</div>
						</div>
	...
	=            section title  container      =
	=============================================-->
			<div class="product-isotope-area mb-100 mb-md-80 mb-sm-80">
				<div class="container">
					<div class="row">
						<div class="col-lg-12">
							<!--=======  fitler titles  =======-->
							...
							<div class="filter-title filter-title--type-one mb-70">
								<ul class="product-filter-menu">
									<li class="active" data-filter="*">Tất cả <span class="filter-separator">/</span></li>
									<li data-filter=".new">New <span class="filter-separator">/</span> </li>
									<li data-filter=".popular">Hot <span class="filter-separator">/</span> </li>
								</ul>
							</div>
						...
						<div class="col-lg-12">
							...
							<div class="row product-isotope">
								...
								<!--=======  single product  =======-->
								<div class="col-12 col-lg-3 col-md-6 col-sm-6 mb-45 popular">
									<div class="single-product">
										<!--=======  single product image  =======-->
										...
										<div class="single-product__image">
											...
											<div class="single-product__floating-icons">
												<span class="wishlist"><a href="{{URL::to('/add-wishlist/id='.$value->ProductID.'')}}" data-tippy="Thêm vào yêu thích" data-tippy-inertia="true"
														data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true"
														data-tippy-theme="sharpborder" data-tippy-placement="left"><i
															class="ion-android-favorite-outline"></i></a></span>
												<span class="compare"><a href="{{URL::to('/add-to-compare_id='.$value->ProductID.'')}}" data-tippy="So sánh" data-tippy-inertia="true"
							...
							<div class="row">
								<div class="col-lg-12 text-center mt-45">
									<a href="shop-left-sidebar.html" class="lezada-button lezada-button--medium"> <i class="ion-plus"></i>
										online store</a>
								</div>
							</div>
						</div>
			...
			<div class="row">
				<div class="col-md-6 mb-30">
					...
					<div class="single-banner single-banner--hoverborder">
						...
						<img src="{{('public/frontend/images/banners/ads1.jpg')}}" class="img-fluid" alt="">
						<div class="banner-content banner-content--middle-white">
							<p> <span class="bold-white">Giảm 10%</span> cho bạn <span class="d-block">vào lần mua tiếp theo</span></p>
						</div>
					</div>
				...
				<div class="col-md-6 mb-30">
					...
					<div class="single-banner single-banner--hoverborder">
						<a class="banner-link" href="shop-left-sidebar.html"></a>
						<img src="{{('public/frontend/images/banners/cabinet.jpg')}}" class="img-fluid" alt="">
						<div class="banner-content banner-content--black-left">
							<p> <span class="big-text">Miễn phí giao hàng</span> <span class="small-text d-block">Cho khách hàng mua với đơn trên 1.000.000</span></p>
						</div>
					</div>
